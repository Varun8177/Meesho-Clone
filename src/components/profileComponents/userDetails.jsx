...
export default function UserInitialDetails({ handleUserDetails }) {
  ...
  return (
    <Box alignItems={"center"}>
      <Stack m={"auto"} w={"fit-content"}>
        <Image margin={"auto"} objectFit={"contain"} src={selectedImage} />
        {/* <InputGroup>
          <InputLeftElement pointerEvents="none" children={<FaFile />} />
      ...
      <TableContainer w={"70%"} m={"auto"}>
        ...
        <Button
          ...
          m={"auto"}
          bgColor={"pink.400"}
          onClick={() => navigate("/profile/user-details-edit")}
          _hover={{
            bg: "pink.500",
          }}
          color={"white"}
