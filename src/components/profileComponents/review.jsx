...
export function ContactFormWithSocialButtons() {
  ...
  const postReview = (name, email, message) => {
    return axios.post("https://63cd0ca00f1d5967f028fa8e.mockapi.io/Reviews", {
      email,
      name,
      message,
    });
  ...
  return (
    ...
    >
      ...
      >
        <Box>
          <VStack spacing={{ base: 4, md: 8, lg: 20 }} height={"550px"}>
            <Stack
              ...
              >
                <VStack spacing={5} height={"500px"}>
                  ...
                  <Button
                    ...
                    isFullWidth
                    onClick={() => {
                      postReview(name, email, message);
                      toast({
                        title: "ThankYou for your feedback ",
                        description: `We will get back to you via email`,
                        status: "success",
                        duration: 5000,
                        isClosable: true,
                      });
